...
# y luego muestre en pantalla cual es la palabra más grande, la palabra más pequeña.
#  Valide que el párrafo ingresado termine en punto sino es así se debe pedir al usuario que ingrese nuevamente
#  el párrafo.
