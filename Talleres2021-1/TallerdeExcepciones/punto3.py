#Punto3.
#  Un taller de biomédica desea tener un archivo para el manejo de los clientes,
#  se pide que desarrolle un programa que en su primera ejecución
#  cree el archivo llamado mantenimientos.txt. 
# Luego en cada ejecución se preguntará por el nombre del equipo médico, una descripción y
#  el precio acordado para el mantenimiento
